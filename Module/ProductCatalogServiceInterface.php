...
interface ProductCatalogServiceInterface {
    ...
    public function searchProduct(SearchCriteria $sc): ProductCollection;		# @todo add search criteria && SearchCriteriaInvalidPageException and  SearchCriteriaInvalidLimitException
